"""
Django settings for blaze_bite project.
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('GMAIL_USERNAME')  # Set this in .env file
EMAIL_HOST_PASSWORD = os.environ.get('GMAIL_PASSWORD')  # Set this in .env file
